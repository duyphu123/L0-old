...
Mock.onGet(ConstantList.ROOT_PATH + "api/calendar/events/all").reply(
  (config) => {
    return [200, calendarEventDB.events];
  }
);

Mock.onPost(ConstantList.ROOT_PATH + "api/calendar/events/add").reply(
  (config) => {
...
Mock.onPost(ConstantList.ROOT_PATH + "api/calendar/events/update").reply(
  (config) => {
...
Mock.onPost(ConstantList.ROOT_PATH + "api/calendar/events/delete").reply(
  (config) => {
